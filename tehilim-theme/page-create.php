...
if ( ! is_user_logged_in() ) :
	...
	<div class="login-page page-anim">
		<div class="login-card">
			...
			<p class="login-subtitle"><?php esc_html_e( 'כדי לפתוח קבוצת תהילים חדשה יש להתחבר לחשבון — כך תוכלו לנהל את הקבוצה, לאשר שגרירים ולעקוב אחרי ההתקדמות.', 'tehilim' ); ?></p>
...
<form class="form-campaign-create create-page">
	<div class="create-header">
		<h1 class="create-title"><?php esc_html_e( 'פתיחת קבוצת תהילים', 'tehilim' ); ?></h1>
		<p class="create-subtitle"><?php esc_html_e( 'שני שלבים קצרים והקבוצה שלכם באוויר.', 'tehilim' ); ?></p>
	</div>
	...
	<div class="create-card">
		...
		<div class="create-label"><?php esc_html_e( 'תמונת הקבוצה', 'tehilim' ); ?></div>
		<div class="create-image" data-mode="upload">
			...
			<div class="create-image-upload">
				...
				<label for="campaign_image" class="create-image-drop">
					...
					<span class="create-image-drop-title"><?php esc_html_e( 'גררו לכאן תמונת הנצחה / לוגו הקבוצה', 'tehilim' ); ?></span>
			...
			<div class="create-image-nonote" hidden>
				<?php esc_html_e( 'בעמוד הקבוצה יוצגו פסוקים נבחרים בשבח אמירת תהילים במקום תמונה.', 'tehilim' ); ?>
			</div>
		</div>

		<div class="create-goal">
			<div class="create-goal-label"><?php esc_html_e( 'יעד הקבוצה', 'tehilim' ); ?></div>
		...
		<button type="submit" class="btn-create-submit"><?php esc_html_e( 'יצירת הקבוצה', 'tehilim' ); ?></button>
	</div>
</form>
