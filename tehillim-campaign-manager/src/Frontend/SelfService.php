...
final class SelfService implements Registerable {
    ...
    public function my_campaigns() {
        if (!is_user_logged_in()) {
            return Templating::render('partials/my-campaigns', array('logged_in' => false, 'campaigns' => array()));
        }
        $query     = new \WP_Query(
            array(
        ...
        return Templating::render('partials/my-campaigns', array('logged_in' => true, 'campaigns' => $campaigns));
    }
    ...
    public function my_activity() {
        if (!is_user_logged_in()) {
            return Templating::render('partials/my-activity', array('logged_in' => false, 'rows' => array()));
        }
        ...
        return Templating::render('partials/my-activity', array('logged_in' => true, 'rows' => $rows));
    }
}
