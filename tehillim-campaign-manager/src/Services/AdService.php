        ...
        return Templating::render(
            ...
            array(
                ...
                'click_url' => add_query_arg(
                    array('tcm_ad_click' => (int) $ad->ID, 'zone' => $zone),
                    home_url('/')
                ),
            )
        );
    ...
    private function pick($zone) {
        ...
        $query = new \WP_Query(
            array(
                ...
                'meta_query'     => array(
                    'relation' => 'AND',
                    array('key' => '_tcm_ad_zone', 'value' => $zone),
                    array('key' => '_tcm_ad_active', 'value' => '1'),
                    array(
                        'relation' => 'OR',
                        array('key' => '_tcm_ad_start', 'value' => '', 'compare' => '='),
                        array('key' => '_tcm_ad_start', 'value' => $today, 'compare' => '<=', 'type' => 'DATE'),
                    ),
                    array(
                        'relation' => 'OR',
                        array('key' => '_tcm_ad_end', 'value' => '', 'compare' => '='),
                        array('key' => '_tcm_ad_end', 'value' => $today, 'compare' => '>=', 'type' => 'DATE'),
                    ),
                ),
            )
        );
