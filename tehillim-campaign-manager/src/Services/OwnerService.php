...
final class OwnerService {
    ...
    public function create(array $data, $user_id) {
        ...
        if ('' === $title) {
            return array('ok' => false, 'code' => 'title_required');
        }
        ...
        if (is_wp_error($post_id)) {
            return array('ok' => false, 'code' => 'create_failed');
        }
        ...
        return array('ok' => true, 'campaign_id' => (int) $post_id, 'permalink' => get_permalink($post_id));
    }
